...
In the article, information on trees is extracted from the database "Arbres, Direction des Espaces Verts et de l'Environnement - Ville de Paris" (under license ODbL) in  in February 2025.
...
- 25 meters: local maps are given in the first column.
